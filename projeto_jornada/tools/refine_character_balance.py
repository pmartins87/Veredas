...
KIT = {
    ...
    "Barqueiro do Reflexo": ("move", "counter", "explorer", "approachable", "skirmisher", "wet"),
    ...
    "Lanceiro Solar": ("damage", "range", "cautious", "approachable", "duelist", "burning"),
    ...
    "Portador da Brasa": ("damage", "resource", "balanced", "intermediate", "bruiser", "burning"),
    ...
    "Repetente": ("echo", "counter", "cautious", "expert", "reactor", "fear"),
    "Curadora de Ecos": ("heal", "echo", "cautious", "approachable", "survivor", "fear"),
    "Tecelão Fraturado": ("resource", "status", "balanced", "expert", "weaver", "shock"),
