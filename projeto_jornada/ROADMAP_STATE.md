...
4. **Contas/infra de publicação reais**: Play Console, assinatura/backup, addon Billing, backend HTTPS/autenticação/retenção, credenciais Play Developer API, produtos/entitlements, canais de suporte/privacidade e fechamento dos documentos públicos.
