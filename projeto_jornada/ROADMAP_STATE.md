...
- 12.3 🟡 — privacidade/Data Safety/plataforma. Estado: `RELEASE_12_3_STATE.json`; contrato `product/privacy_data_safety.json`, draft `docs/PRIVACY_POLICY_DRAFT.md`, gate `tools/privacy_data_safety_gate.py`. Faltam dados finais pós-Billing/AAB, URL/contato e submissão coerente.
